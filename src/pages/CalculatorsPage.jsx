...
const CALCULATOR_SCHEMAS = [
  ...
  {
    name: '육아휴직급여 계산기',
    description: '월 통상임금과 사용 개월수로 구간별 예상 육아휴직급여 총액을 계산하는 무료 계산기',
    path: '/calculators/parental-leave',
  },
  {
    name: '4대보험 계산기',
    description: '보수월액으로 국민연금·건강보험·장기요양·고용보험의 근로자·사업주 부담분을 계산하는 무료 계산기',
  ...
  return (
    <div className="page page--calculators">
      <Seo
        ...
        description="4대보험, 전기요금, 도시가스, 건강보험, 국민연금, 퇴직금, 실업급여, 연차수당, 육아휴직급여 등 생활비 관련 계산기를 이용해보세요. 무료로 예상 생활비를 확인하고 절약 방법을 찾아보세요."
        keywords="생활비 계산기, 4대보험 계산기, 전기요금 계산기, 도시가스 계산기, 건강보험 계산기, 퇴직금 계산기, 실업급여 계산기, 연차수당 계산기, 육아휴직급여 계산기"
      ...
      <div className="page__content">
        ...
        <p className="page__notice">
          연봉 실수령액·4대보험·퇴직금·실업급여·연차수당·육아휴직급여·전기요금·도시가스·국민연금·건강보험(직장가입자) 계산기를 이용할 수 있습니다.
