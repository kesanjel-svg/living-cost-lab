  ...
  return (
    <div className="page page--calculators">
      <Seo
        ...
        description="전기요금, 도시가스, 건강보험, 국민연금, 퇴직금, 실업급여 등 생활비 관련 계산기를 이용해보세요. 무료로 예상 생활비를 확인하고 절약 방법을 찾아보세요."
        keywords="생활비 계산기, 전기요금 계산기, 도시가스 계산기, 건강보험 계산기, 퇴직금 계산기, 실업급여 계산기"
      ...
      <div className="page__content">
        ...
        <p className="page__notice">
          연봉 실수령액·퇴직금·실업급여·전기요금·도시가스·국민연금·건강보험(직장가입자) 계산기를 이용할 수 있습니다.
