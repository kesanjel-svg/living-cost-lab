...
export const GAS_REGIONS = {
  ...
  gyeonggi: {
    ...
    vatIncluded: false,
    source: 'http://www.citygas.or.kr/info/charge.jsp',
    note: '경기도 내 다수 지역(수원·부천·평택·안양 등, 삼천리 관할)을 포함한 대표값. 경기도는 공급사(삼천리·코원에너지서비스·예스코·대륜이엔에스·서울도시가스 등)와 무관하게 도 전체에 동일한 소매요금이 적용됨을 다수 공급사 공식 요금조회 결과로 교차 확인함(2026-07-06·2026-07-10 확인, 상세는 "성남"·"남양주"·"의정부"·"용인"·"고양" 등 지역 항목 참고).',
  },
  yongin: {
    name: '용인(경기)',
    provider: '삼천리',
  ...
  goyang: {
    ...
    vatIncluded: false,
    source: 'https://www.seoulgas.co.kr/mobile/payment/gasPayTable',
    note: '한국가스공사 공식 공급구역 안내(2026-07-10 확인)로 고양·파주시(경기)가 서울도시가스㈜ 관할임을 확인. 서울도시가스 공식 요금조회 페이지에서 "지역구분: 경기"를 선택해 실측 확인한 결과(2026-07-01 적용) 주택용 취사·난방 22.6226원/MJ, 기본요금 1,250원으로 기존 "서울" 항목(22.3617원/MJ)과는 다르고 "경기도" 항목과는 완전히 동일함 — 서울도시가스도 서울 자체 요금과는 별도로 경기 권역엔 경기도 공통 요금을 적용함을 5번째 공급사로 교차검증.',
  },
  paju: {
    name: '파주(경기)',
    provider: '서울도시가스',
    ...
    vatIncluded: false,
    source: 'https://www.seoulgas.co.kr/mobile/payment/gasPayTable',
    note: '한국가스공사 공식 공급구역 안내(2026-07-10 확인)로 고양·파주시(경기)가 서울도시가스㈜ 관할임을 확인. 서울도시가스 공식 요금조회 페이지에서 "지역구분: 경기"를 선택해 실측 확인한 결과(2026-07-01 적용) 주택용 취사·난방 22.6226원/MJ, 기본요금 1,250원으로 기존 "서울" 항목(22.3617원/MJ)과는 다르고 "경기도" 항목과는 완전히 동일함 — 서울도시가스도 서울 자체 요금과는 별도로 경기 권역엔 경기도 공통 요금을 적용함을 5번째 공급사로 교차검증. 김포시는 서울도시가스·인천도시가스 두 공급사 권역으로 분할되어 있어(한국가스공사 공급구역 안내 기준) 이번 라운드에서는 제외.',
  },
  seongnam: {
    name: '성남(경기)',
    provider: '코원에너지서비스',
...
// 미지원 지역용 근사치. 조사 완료된 46개 지역의 단순 평균으로 산출하며,
...
export function getNationwideAverageRegion() {
  ...
  return {
    ...
    vatIncluded: false,
    source: null,
    note: '아직 지원하지 않는 지역이라 조사 완료된 46개 지역(서울·인천·부산·대구·경산·광주·대전·울산·경기·용인·화성·고양·안산·파주·시흥·성남·남양주·의정부·경남·진주·양산·세종·강원·강릉·속초·원주·횡성·평창·청주·충주·천안·아산·공주·보령·서산·전주·군산·익산·포항·구미·경주·안동·여수·순천·목포·제주) 요금의 단순 평균으로 근사 계산한 값입니다. 실제 거주 지역 도시가스사 요금표를 확인하세요.',
    isApproximate: true,
  }
}
