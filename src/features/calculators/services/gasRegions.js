...
export const GAS_REGION_ORDER = ['seoul', 'incheon', 'busan', 'daegu', 'gwangju', 'daejeon']
...
// 미지원 지역용 근사치. 조사 완료된 6개 지역의 단순 평균으로 산출하며,
...
export function getNationwideAverageRegion() {
  ...
  return {
    ...
    vatIncluded: false,
    source: null,
    note: '아직 지원하지 않는 지역이라 조사 완료된 6개 지역(서울·인천·부산·대구·광주·대전) 요금의 단순 평균으로 근사 계산한 값입니다. 실제 거주 지역 도시가스사 요금표를 확인하세요.',
    isApproximate: true,
  }
}
