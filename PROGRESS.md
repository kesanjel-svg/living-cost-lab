...
3. **국민연금 기준소득월액 상·하한 재검증** (아래 별도 항목 참고 — 계산기 정확성에 직결되므로 우선순위 높음 후보)
4. **도시가스 계산기 지역 확장** (경기/강원/충청/전라/경상 소도시 등)

### ⚠️ 별도 재검증 건 (급하지 않음, 놓치지 말 것)
**국민연금 기준소득월액 상·하한 재검증 필요**:
- 기존 구현: 2026.7~2027.6 적용분 하한 41만원 / 상한 659만원
- 2026-07-05 세션 검색 중 다른 자료에서 하한 40만원 / 상한 637만원 수치 발견
- 반기별 조정 시점 차이 가능성 — 국민연금공단 공식 고시로 재확인 필요. 국민연금 계산기 관련 작업 시 반드시 함께 확인
