...
3. **도시가스 계산기 지역 7차 확장 후보**: 의정부(대륜이엔에스, 자체 사이트 로그인 장벽 재시도 또는 대체 출처 필요) 외에 아직 미확인 소도시(충청/전라/경상 잔여 지역 등) — 협회 표에 이미 확인된 지역은 대부분 소진되었으므로 다음 라운드는 협회 표에 없는 지역부터 개별 조사 필요할 가능성 높음
